...
describe('Android update checker', () => {
  ...
  it('selects the newest stable release and its exact APK asset', async () => {
    const fetchImpl = async () => new Response(JSON.stringify([
      { tag_name: 'android-v0.1.0', draft: false, prerelease: false, assets: [{ name: 'Words-of-Yeshua-Android-0.1.0.apk', size: 100 }] },
      { tag_name: 'android-v0.2.0', draft: false, prerelease: false, assets: [{ name: 'Words-of-Yeshua-Android-0.2.0.apk', size: 200 }] },
